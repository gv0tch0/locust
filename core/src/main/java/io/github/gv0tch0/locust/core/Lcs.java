...
public interface Lcs {
    /**
     * @param words The collection of words longest common substring is computed for.
     * @return The longest common substring(s) for the given words. The returned
     *         {@link Set} contains more than one entry when there are more than one
     *         distinct longest common substrings of the same length. When the given
     ...
     *         is a copy of the given words collection.
